    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        @if(Auth::user()->role === 'admin')
            <a href="{{ route('admin.users.index') }}" class="block p-6 bg-white dark:bg-[#161615] border border-[#19140015] dark:border-[#ffffff15] rounded-lg hover:bg-gray-50 dark:hover:bg-[#1f1f1e] transition-colors">
                <span class="text-xs font-bold text-[#706f6c] uppercase tracking-widest">Zarejestrowani Użytkownicy</span>
        ...
        @endif
        <div class="p-6 bg-white dark:bg-[#161615] border border-[#19140015] dark:border-[#ffffff15] rounded-lg">
            <span class="text-xs font-bold text-[#706f6c] uppercase tracking-widest">Aktywne Wypożyczenia</span>
            <p class="text-3xl font-bold mt-1 text-[#f53003]">{{ $stats['active_loans'] }}</p>
        </div>
        <div class="p-6 bg-white dark:bg-[#161615] border border-[#19140015] dark:border-[#ffffff15] rounded-lg">
            <span class="text-xs font-bold text-[#706f6c] uppercase tracking-widest">Oczekujące Rezerwacje</span>
